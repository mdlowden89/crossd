  ...
  return (
    <>
      <style>{`
        ...
        .hiw-h1-line1 { display: block; font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: clamp(32px, 5vw, 48px); font-weight: 800; color: #fff; letter-spacing: -0.02em; margin-bottom: 6px; }
